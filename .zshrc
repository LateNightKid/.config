...
alias sshitgenproxy="ssh -p 6022 -C $ITGENPROXY"
alias sshruvds-moscow-2="ssh -p 6022 $RUVDSMOSCOW2"
alias tmux="TERM=xterm-256color tmux"
alias sshvdsina-ams-1="ssh -p 6022 $VDSINAAMS1"
alias sshvdsina-ams-2="ssh -p 6022 -i ~/.ssh/vdsina-ams-2 $VDSINAAMS2"
...
# For java gui to work properly
export DISPLAY=$(ip route list default | awk '{print $3}'):0

# Scaling factor for gui apps, set it bc firefox
